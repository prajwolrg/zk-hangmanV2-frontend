...
yup.addMethod(yup.string, "ethereumAddress", function (errMsg) {
  return this.test(`test-ethereum-address`, errMsg, function (value) {
    ...
    return (
      ...
      createError({ path, message: errMsg ? errMsg : "Enter a valid Ethereum Address" })
    );
  });
});
        ...
        {({ handleSubmit, errors, touched }) => (
          <form onSubmit={handleSubmit}>
            <VStack spacing={4} align="flex-start">
              ...
              <FormControl isInvalid={!!errors.hostAddress && touched.hostAddress}>
              ...
              <FormControl isInvalid={!!errors.playerAddress && touched.playerAddress}>
